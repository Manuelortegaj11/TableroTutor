      ...
      <div class="overflow-x-auto">
         <table class="min-w-full bg-white border border-gray-300">
            ...
            <tbody>
               ...
               <tr>
                  <td class="py-2 px-4 border-b text-center">{{$formulario->nombre_completo}}</td>
                  <td class="py-2 px-4 border-b text-center">{{$formulario->codigo_estudiantil}}</td>
                  <td class="py-2 px-4 border-b text-center">{{$formulario->telefono}}</td>
                  <td class="py-2 px-4 border-b text-center">{{$formulario->nivel_estudiante}}</td>
                  <td class="py-2 px-4 border-b text-center">

            <div class="flex justify-center flex-wrap">
                     <a href="{{ url('/listado-proximo-graduado/'.$formulario->id).'/edit' }}" class="m-1 button-link bg-unimagBlue hover:bg-white text-white font-bold py-1 px-2 rounded-full mr-1">
                ...
                <form action="{{ url('/listado-proximo-graduado/'.$formulario->id) }}" class=""  method="post">
                @csrf
                {{ method_field('DELETE') }}
                <button type="submit" onclick="return confirm('Quieres borrar?')" class="m-1 button-link bg-red-500 hover:bg-white text-white font-bold py-2 px-1 rounded-full mr-1">
