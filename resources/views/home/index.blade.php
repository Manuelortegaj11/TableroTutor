...
<body>
    <footer class="footer p-3 bg-unimagBlue2 text-base-content">
...
-->
<footer
  class="bg-unimagBlue text-center text-neutral-600 dark:bg-unimagBlue dark:text-neutral-200 lg:text-left">
